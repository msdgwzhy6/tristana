...
export const BASE_API = (process.env.NODE_ENV === 'development' ? '//localhost:9000/api/v1/' : (process.env.NODE_ENV == 'test' ? 'https://downfuture.com:9000/api/v1/' : 'https://downfuture.com:9000/api/v1/'));
